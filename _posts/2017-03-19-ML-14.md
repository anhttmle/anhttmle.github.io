---
title: "Machine Learning long term and a Learning path"
date: 2017-03-19
layout: post
...
Trong ML, Linear Algebra (LA) xuất hiện nhan nhản do phải xử lý cấu trúc dữ liệu cho giải thuật cũng như số lượng feature lớn. Một số kiến thức và chủ đề các bạn nên quan tâm:
...
Việc biến đổi các tham số hay trọng số trong ML để đưa ra được mô hình dự đoán tốt sử dụng nhiều kĩ thuật của Calculus, chẳng hạn như Gradient Descent ta sử dụng đạo hàm, CNN (Convolutional Neural Network) bạn nên hiểu về convolution, Back Propagation ta đã sử dụng Chain Rule trong việc tính đạo hàm, …
