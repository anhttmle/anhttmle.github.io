---
title: "How to design Machine Learning System"
date: 2017-02-21
layout: post
...
## Recap: Error metrics for skewed classes

| Metric | Công thức | Ý nghĩa |
|---|---|---|
| Precision | TP / (TP + FP) | Trong những cái được dự đoán là dương, bao nhiêu % là đúng |
| Recall | TP / (TP + FN) | Trong những cái thực sự là dương, bao nhiêu % được phát hiện |
| F1 Score | 2 × (P × R) / (P + R) | Cân bằng giữa Precision và Recall |

**Khi nào dùng cái nào?**
- Dùng **Precision** khi False Positive tốn kém (ví dụ: spam filter — không muốn chặn nhầm email quan trọng).
- Dùng **Recall** khi False Negative tốn kém (ví dụ: chẩn đoán ung thư — không muốn bỏ sót bệnh nhân).
- Dùng **F1** khi cần cân bằng cả hai.
- **Accuracy không dùng được** khi class imbalance nặng.
